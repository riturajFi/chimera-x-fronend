export const _4POOL_DEPOSIT_ABI = [
  {
    name: "Transfer",
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "token_amounts", type: "uint256[4]", indexed: false },
      { name: "fees", type: "uint256[4]", indexed: false },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "new_fee", type: "uint256", indexed: false },
    ],
    anonymous: false,
    type: "event",
  },
  ...
  },
  {
    ...
    type: "function",
    name: "commit_new_fee",
    inputs: [{ name: "new_fee", type: "uint256" }],
    outputs: [],
  },
  {
    stateMutability: "nonpayable",
